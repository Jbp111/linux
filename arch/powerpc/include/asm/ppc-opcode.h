...
#define PPC_RAW_TLBIEP(rb, rs, ric, prs, r) \
	(0x7c000032 | ___PPC_RB(rb) | ___PPC_RS(rs) | ___PPC_RIC(ric) | ___PPC_PRS(prs) | ___PPC_R(r))
...
#define	PPC_TLBIEP(rb, rs, ric, prs, r) \
				stringify_in_c(.long PPC_RAW_TLBIEP(rb, rs, ric, prs, r))
